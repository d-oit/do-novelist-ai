 ...
 */
export const generateEpub = async (project: Project, enableDropCaps: boolean = false): Promise<Blob> => {
  const zip = new JSZip();
...
<body>
  ...
  project.chapters.forEach((chapter) => {
    ...
    oebps.file(`chapter-${chapter.orderIndex}.xhtml`, `<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
...
<body>
  ...
  const manifestItems = [
    ...
    ...project.chapters.map(c => `<item id="ch${c.orderIndex}" href="chapter-${c.orderIndex}.xhtml" media-type="application/xhtml+xml"/>`)
  ];
...
<package xmlns="http://www.idpf.org/2007/opf" unique-identifier="BookId" version="3.0">
  ...
  const navPoints = [
    ...(coverFilename ? [`<navPoint id="navPoint-0" playOrder="0"><navLabel><text>Cover</text></navLabel><content src="cover.xhtml"/></navPoint>`] : []),
