    ...
    <>
      <motion.header
        className={cn(
          ...
          "bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl backdrop-saturate-150",
      ...
      >
        ...
        >
          ...
          {/* Logo & Brand */}
          <motion.button
            className="flex items-center gap-3 group cursor-pointer transition-transform duration-200" 
          ...
          >
            <div className={cn(
              ...
              "group-hover:shadow-lg group-hover:shadow-primary/20 transition-all duration-200",
            ...
            <div className="hidden md:block">
              <div className="flex items-center gap-2">
                <h1 className="font-bold text-lg leading-none bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent text-shadow-sm">
                  Novelist.ai
                </h1>
          ...
          <div className="hidden md:flex items-center gap-4">
            <div 
              className="flex flex-col text-right mr-2 border-r border-border/60 pr-4" 
            ...
            <button
              ...
              className={cn(
                ...
                "hover:scale-[0.98] active:scale-95 hover:shadow-lg",
          ...
          <button
            className={cn(
              "md:hidden p-2.5 text-muted-foreground hover:text-foreground",
              "transition-all duration-200 rounded-lg hover:bg-secondary/50",
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <>
            ...
            <motion.div
              className={cn(
                "md:hidden fixed inset-0 bg-black/20 backdrop-blur-sm",
