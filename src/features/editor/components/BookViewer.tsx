...
import { Project, Chapter, ChapterStatus, type ChapterStatusType, RefineOptions } from '../../../types/index';

// ...

const getStatusConfig = (status: ChapterStatusType) => {
  switch (status) {
