...
#### 2.4 Voice Input (Dictation) (LOW Priority, 2-3 days)
...
- [ ] Multi-Modal AI generates covers/portraits
- [ ] PWA installable and offline writing works
- [ ] Distraction-Free mode functional
- [ ] Voice input works in major browsers
- [ ] All new features have tests passing

**Success Metrics**:

- Multi-Modal AI: >30% adoption
- PWA: >50% installs, >20% offline usage
- Distraction-Free: >40% usage, +20% session length
- Voice Input: >15% usage, NPS > 7
